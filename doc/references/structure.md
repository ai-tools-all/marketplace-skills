...
read by the stdlib-only parser in `scripts/_yaml.py` (no PyYAML needed).
...
# → Created 025-cursor-null-timestamps/plans/01-2026-04-05-07-13-29-root-cause-analysis.md

/doc plan 25 "revised approach"
# → Created 025-cursor-null-timestamps/plans/02-2026-04-05-09-40-11-revised-approach.md
```
...
type: plan
topic: "cursor-null-timestamps"
status: draft
created: "2026-04-05 07:13 UTC"
related: "experiments/025-cursor-null-timestamps"
---
...
# → Created 025-cursor-null-timestamps/findings/01-2026-04-05-07-20-04-timestamps-missing-in-v2-format.md

/doc finding 25 "codex double encodes json"
# → Created 025-cursor-null-timestamps/findings/02-2026-04-05-08-02-55-codex-double-encodes-json.md
```
...
# → Created 025-cursor-null-timestamps/checkpoints/01-2026-04-05-11-30-00-initial-investigation-done.md
```
...
# → Created 025-cursor-null-timestamps/research/01-2026-04-05-07-13-29-prompt-process-mining-literature.md
# → Created 025-cursor-null-timestamps/research/01-2026-04-05-07-13-29-res-process-mining-literature.md
```
...
# → Created learnings/data/001-2026-04-05-12-00-00-cursor-null-timestamps.md
...
│       └── NNN-{datetime}-title.md  # Frontmatter links back to source experiment
│
...
# Default `status:` value per doc type, written into frontmatter
frontmatter:
  status:
    plan: draft
    finding: active
...
statuses: [planning, active, complete, abandoned, graduated]
```
...
| `{datetime}` | UTC stamp per `naming.datetime` | `2026-04-05-07-13-29` |
| `{date}` | UTC date only | `2026-04-05` |
...
**The sequence token must stay first.** `next_number()` reads the leading `^[0-9]+`
off existing filenames. A template starting with `{datetime}` makes it parse the
year (`2026`) as the sequence, and the next file is named `2027-*`.
