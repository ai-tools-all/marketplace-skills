...
- **[to-tickets](./to-tickets/SKILL.md)** — Break any plan, spec, or conversation into a set of tracer-bullet tickets, each declaring its blocking edges — `/doc` experiment files on a local tracker, or native blocking links on a real tracker.
