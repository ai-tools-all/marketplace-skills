...
#[command(
    ...
    before_help = "Default flow: init -> pre-commit (runs validate/bump/update). If a step fails, run the individual subcommands. see `pre-commit` command help message to understand the sequence.",
